...
return [
  ...
  'The following module(s) do not yet offer a compatible version for the new HumHub version. To proceed with the update, you must uninstall these modules.' => 'Os seguintes módulos ainda não oferecem uma versão compatível com a nova versão do HumHub. Para prosseguir com a atualização, você precisa desinstalá-los.',
  ...
  'Update' => 'Atualizar',
  'Update Blocked – Incompatible Module(s)' => 'Atualização bloqueada – Módulo(s) incompatível(eis)',
  'Update HumHub' => 'Atualizar Humhub',
  'Update download failed! (%error%)' => 'Falha no download da atualização! (%erro%)',
  'Update module: {moduleName}' => 'Módulo de atualização: {moduleName}',
